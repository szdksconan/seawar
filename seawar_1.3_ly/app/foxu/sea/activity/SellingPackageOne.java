 ...
 *
 */
public class SellingPackageOne extends Activity implements ActivitySave
{
	...
	public String checkGems(Player player,CreatObjectFactory factory)
	{
		...
		// 宝石消费记录
		factory.createGemTrack(GemsTrack.SELLING_P_ONE,player.getId(),price,
	...
	{
		SellingPackageOne one=(SellingPackageOne)super.copy(obj);
		one.mapRecord=new IntKeyHashMap();
		return one;
	}
	/** 初始化 **/

 ...
 *
 */
public class SellingPackageTwo extends Activity implements ActivitySave
{
	...
	public String checkGems(Player player,CreatObjectFactory factory)
	{
		...
		// 宝石消费记录
		factory.createGemTrack(GemsTrack.SELLING_P_TWO,player.getId(),price,
	...
	{
		SellingPackageTwo two=(SellingPackageTwo)super.copy(obj);
		two.mapRecord=new IntKeyHashMap();
		return two;
	}
	/** 初始化 **/

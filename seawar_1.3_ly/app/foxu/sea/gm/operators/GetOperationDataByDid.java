 ...
 *
 */
public class GetOperationDataByDid extends GMOperator
{
		...
		JSONArray jsonArray,ServerInfo info)
	{
		...
		GDataByDidMemCache memCache=objectFactory.getgDataByDidCache();
...
//			System.out.println(data60.getThe_month()+":--------data60--------:"+data60.getThe_day());
	...
	public ArrayList getMonthData(GDataByDidMemCache memCache,int year,
